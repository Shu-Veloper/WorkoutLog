...
탭 1: 홈 (Home) - 운동 기록 및 달력 페이지
탭 2: 식단 (Nutrition) - 식단 관리 페이지
탭 3: 미정 - 향후 기능 추가 예정
...
│                                         │
├─────────────────────────────────────────┤
│  [Home]    [Nutrition]    [Coming Soon] │  ← Sticky Footer Tab
└─────────────────────────────────────────┘
...
│                                         │
├─────────────────────────────────────────┤
│    [Home] [Nutrition] [Coming Soon]     │  ← Sticky Footer
└─────────────────────────────────────────┘
7.2 달력 페이지 상세
┌──────────────────────────────────────────┐
│         2025년 1월 달력                   │
